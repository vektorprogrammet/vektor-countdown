...
<script>
    ...
    export default {
        ...
        methods:{
            ...
            play_10s_notification: async function(user, applicant_number) {
                ...
                const tts_url = process.env.VUE_APP_TTS_URL ? process.env.VUE_APP_TTS_URL : 'http://localhost:1337'
                const buffer = await fetch(tts_url, {
                    method: "POST",
                    body: firstName 
                })
                ...
                self.colorParty(sound.duration+buffer.duration+sound3.duration);
                sound.play();
